...
public class TopicNode {
    ...
    private double lastSelectionValue;
    ...
    public double getLastSelectionValue() {
        return this.lastSelectionValue;
    }
    ...
    public void setLastSelectionValue(double selectionValue) {
        this.lastSelectionValue = selectionValue;
    }
